...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Benediction | AI-Powered Cybersecurity & Defence Technology" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Benediction" },
      { property: "og:title", content: "Benediction | AI-Powered Cybersecurity & Defence Technology" },
      {
